  ...
  return (
    <>
      <Section spacing="md">
        <Container>
          <div className="max-w-2xl mx-auto text-center">
            <Overline className="mb-3">Pricing</Overline>
            <h1 className="text-hero font-bold tracking-tight text-neutral-900 mb-4">
              Simple, transparent pricing
            </h1>
            <Body size="lg">Start free. Upgrade when you&apos;re ready. No hidden fees, ever.</Body>
          </div>
        </Container>
      </Section>
      ...
      <Section spacing="lg" className="bg-neutral-50/80">
        <Container size="md">
          <h2 className="text-title font-semibold text-neutral-900 text-center mb-12 tracking-tight">
          ...
          <dl className="space-y-8">
            {faqs.map((faq) => (
              <div key={faq.q} className="border-b border-neutral-200 pb-8 last:border-0 last:pb-0">
                ...
                <dd className="text-sm text-neutral-500 leading-relaxed">{faq.a}</dd>
              </div>
            ))}
          </dl>
        </Container>
